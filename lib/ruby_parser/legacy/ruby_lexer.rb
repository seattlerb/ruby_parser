...
module RubyParserLegacy
  class RubyLexer
    ...
    def initialize v = 18
      ...
      self.cmdarg = ::LegacyRubyParserStuff::StackState.new(:cmdarg, $DEBUG)
      self.cond   = ::LegacyRubyParserStuff::StackState.new(:cond, $DEBUG)
    ...
    def process_token text
      ...
      unless in_lex_state? :expr_dot then
        ...
        keyword = if ruby18 then # REFACTOR need 18/19 lexer subclasses
                    LegacyRubyParserStuff::Keyword.keyword18 token
                  else
                    LegacyRubyParserStuff::Keyword.keyword19 token
                  end
